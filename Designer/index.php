...
<div class ="wspContainer">
	<div class ="titleWhitespace">
		...
		<div class="mySlides fade">
		  <div class="numbertext">Tervezés</div>
		  <img src="mainElements/adv-banner-main.png"onContextMenu="return false;" style="width:100%">
		  <div class="text"><a href="#" style="text-decoration: revert;">Tervezd meg a saját ajándékod! ➤</a></div>
		</div>

		<div class="mySlides fade">
		  <div class="numbertext">Akciók</div>
		  <img src="mainElements/adv-banner-discount.png"onContextMenu="return false;" style="width:100%">
		  <div class="text"><a href="#" style="text-decoration: revert;">Nézd át az akciókat! ➤</a></div>
		</div>

		<div class="mySlides fade">
		  <div class="numbertext">Kész</div>
		  <img src="mainElements/adv-banner-idea.png" onContextMenu="return false;"style="width:100%">
		  <div class="text"><a href="#" style="text-decoration: revert;">Nézd át a kész termékeket! ➤</a></div>
		</div>
		...
		<p><strong>Miért jobbak az egyedi ajándékok?</strong></p>
	</div>
</div>
