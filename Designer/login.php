...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Kérlek, írd be az e-mail címed.";
    } else{
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "Helytelen e-mail vagy jelszó.";
                        }
                    }
                } else{
                    // Username doesn't exist, display a generic error message
                    $login_err = "Nincs regisztrálva ilyen e-mail cím.";
                }
            } else{
                echo "Hoppá! Valami nem ment ahogy kell. Kérlek, próbáld meg késobb.";
            }
...
<?php
						...
						if(!empty($_GET)) {
							...
							<script type="text/javascript">
								...
								alertify.success("Sikeresen regisztráltál!");
								alertify.success("Most jelentkezz be!");
									</script>
								';
							} 
		...
		<div id="box_main">
			...
			<div class="text">
				...
				<div>
					...
					<?php 
					if(!empty($login_err)){
						echo '<script> 	alertify.error("' . $login_err . '");</script>';
					}        
					?>
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						...
						<label>Még nincs fiókod? <a href="register.php">Regisztrálj</a>!</label>
					</form>
				</div>
